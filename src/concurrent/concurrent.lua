...
return function(Roact, Scheduler)
	...
	local useFrame = require(hooksWorkspace.useFrame)(Roact)
	local DivLike = require(componentsWorkspace.DivLike)(Roact)
	local Canvas = require(componentsWorkspace.Canvas)(Roact)
